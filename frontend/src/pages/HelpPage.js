            ...
            <div className="container py-4 px-3 rounded bg-white">
                ...
                <section id="bug-report" className="section-title">
                    ...
                    <p>
                        ...
                        <a
                            href="https://github.com/akhilesh7879/plants.git"
                            target="_blank"
                ...
                <section id="contact-us" className="section-title">
                    ...
                    <p>
                        <strong>Email:</strong>{" "}
                        <Link to="mailto:itskarankushwaha@gmail.com">itskarankushwaha@gmail.com</Link>
                    </p>
                    <p>

                        <strong>Phone:</strong>
                        <Link to="tel:+91 9009803907"> +91 9009803907</Link>
                    </p>
                    <p>
                        <strong>Address:</strong> Sirali, Dist - Harda, MP
                    </p>
                </section>
