...
const PrivacyPolicyPage = () => {
    return (
        ...
        <div className="container py-4 px-3 rounded bg-white">
          ...
          <p className="text-center">Last updated: May 18, 2025</p>
          <p>
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <ul>
                ...
                <li><strong>Country</strong> refers to Indore, India.</li>
          ...
          <ul>
            <li>Email: <Link to="mailto:itskarankushwaha@gmail.com">itskarankushwaha@gmail.com</Link></li>
            <li>Phone: <Link to="tel:+91 9009803907">+91 9009803907</Link></li>
          </ul>
        </div>
      </section>
    )
